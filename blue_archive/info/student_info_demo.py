...
students_url = "https://lonqie.github.io/SchaleDB/data/tw/students.json"
localization_tw_url = "https://lonqie.github.io/SchaleDB/data/tw/localization.json"
...
def get_student_info(nickname):
    ...
    localization_tw_data = get_json_data(localization_tw_url)
    localization_jp_data = get_json_data(localization_jp_url)
    if common_data == None or student_data == None or localization_tw_data == None or localization_jp_data == None:
        return
