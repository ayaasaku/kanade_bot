...
class EventCog(commands.Cog, name='event'):
    ...
    async def event(self, interaction: discord.Interaction):
        ...
        embed.add_field(name='加成屬性', value=f'{event_attribute_translated} {attribute_emoji}', inline=False)
        embed.add_field(name='加成角色', value=f'{event_bonus_characters_name_list[0]}\n{event_bonus_characters_name_list[1]}\n{event_bonus_characters_name_list[2]}\n{event_bonus_characters_name_list[3]}\n', inline=True)
