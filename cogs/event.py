...
class EventCog(commands.Cog, name='event'):
    ...
    async def event(self, interaction: discord.Interaction):
        ...
        embed.add_field(name='加成角色', value=f'{event_bonus_characters_name_list[0]}，{event_bonus_characters_name_list[1]}，{event_bonus_characters_name_list[2]}，{event_bonus_characters_name_list[3]}\n\u200b', inline=False)
