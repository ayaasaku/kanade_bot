...
class SekaiClient(object):
    ...
    def register(self) -> SekaiUser:
        ...
        print(data)
        credential = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjcmVkZW50aWFsIjoiZmZiZGZmNGMtZDQ2My00ZjIxLThlMzMtOGQ5NDE2NzY4MjA0IiwidXNlcklkIjoiMTI5NTAyNzg1NzAwNzc3OTg0In0.Z-jZk0kd-8YxuKjXxvGFJAWlgDzmSh0NElgqqOlf_5Q" #data["credential"]
        uid = "129502785700777984" #data["userRegistration"]["userId"]
